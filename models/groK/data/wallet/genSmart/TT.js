...
const subject = process.argv[2] || 'tax'; //  Obtenir le sujet via l'argument de ligne de commande
...
const subjects = [
  `
    "Impôt_sur_le_revenu",
    "Revenus_salariaux_et_assimilés",
    "Revenus_et_profits_du_patrimoine_mobilier",
    "Revenus_fonciers_et_profits_du_patrimoine_immobilier",
    "Bénéfices_agricoles",
    "Bénéfices_non_commerciaux",
    "Bénéfices_industriels_et_commerciaux",
    "Impot_sur_les_sociétés",
    "Taxe_sur_la valeur ajoutée",
    "Taxes_sur_le_chiffre_d_affaires",
    "Cotisation_sur_la_Valeur_Ajoutée_des_Entreprises",
    "Taxes_et_participations_sur_les_salaires",
    "Taxes_sur_les_facteurs_de_production",
    "Autres_impositions_sectorielles",
    "Impôts_fonciers",
    "Impôts_sur_le_patrimoine",
    "Enregistrement",
    "Taxe_sur_les_conventions_dassurances_et_assimilées",
    "Recouvrement",
    "Droit_à_l_erreur",
    "Contrôle_fiscal",
    "Contentieux",
    "Sécurité_juridique",
    "Fiscalité_internationale",
    "Cadastre",
    "Dispositions juridiques_communes",
    "Rescrits",
    "xes",
    "NTF",
    "CDO",
...
async function main() {
  for (const subject of subjects) {
    try {
      ...
      const outputFilePath = `tax/devops_${subject}_` + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
